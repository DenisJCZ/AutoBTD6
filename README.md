...
The config files (list of maps, monkey upgrade costs) are currently set up for **Bloons TD6 v<span id="version">55.0</span>**.
<br>
...
the heros `psi`, `geraldo` and `corvus` are not supported
...
I recommend you to record your own playthroughs, as most of the ones I tried from the original script did not work anyways.
